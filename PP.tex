...
\begin{document}
    ...
    \begin{figure}[!t]
        ...
        \begin{minipage}{0.49\textwidth}
            ...
            ~\\
            The problem solving in this work is the difficulty in measuring and predicting the success of IT projects due to the ambiguity and interconnectedness of various factors. This is important because the successful implementation of IT projects is crucial for businesses in today's technology-dependent world. The program I am proposing will provide a tool for visualizing and understanding these complex relationships, thereby aiding in decision-making and project management.\\
            ~\\
