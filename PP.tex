...
\begin{document}
    ...
    \begin{figure}[!t]
        ...
        \begin{minipage}{0.49\textwidth}
            ...
            \end{center}
            The area of the research is the application of fuzzy cognitive maps in modeling and understanding the success factors of IT projects. This involves the development of a program that uses fuzzy computing models to visualize and analyze these factors and their interrelationships. The research also explores the use of this program in various fields such as IT project management, research in the field of IT, artificial intelligence, cognitive science, education and using in combination with other methods.\\
            ~\\
